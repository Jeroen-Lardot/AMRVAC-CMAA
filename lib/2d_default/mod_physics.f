...
module mod_physics
  ...
  abstract interface
     ...
     subroutine sub_energy_synchro(qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
     ...
     subroutine sub_check_w(primitive, ixImin1,ixImin2,ixImax1,ixImax2,&
         ixOmin1,ixOmin2,ixOmax1,ixOmax2, w, w_flag, smallw)
       use mod_global_parameters
...
contains
  ...
  subroutine phys_check()
    ...
    if (.not. associated(phys_set_mg_bounds)) phys_set_mg_bounds => &
       dummy_set_mg_bounds
    ...
    if (.not. associated(phys_get_tgas)) phys_get_tgas => dummy_get_tgas

    if (.not. associated(phys_get_trad)) phys_get_trad => dummy_get_trad
  ...
  subroutine dummy_check_w(primitive, ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
     ixOmin2,ixOmax1,ixOmax2, w, w_flag, smallw)
    use mod_global_parameters
    logical, intent(in)          :: primitive
  ...
  subroutine dummy_get_tgas(w, x, ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
     ixOmin2,ixOmax1,ixOmax2, tgas)
    use mod_global_parameters
  ...
  subroutine dummy_get_trad(w, x, ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
     ixOmin2,ixOmax1,ixOmax2, trad)
    use mod_global_parameters
