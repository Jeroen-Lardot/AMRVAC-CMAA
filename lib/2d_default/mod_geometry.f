...
contains
  ...
  subroutine get_surface_area(s,ixGmin1,ixGmin2,ixGmax1,ixGmax2)
    ...
    double precision :: x(ixGmin1:ixGmax1,ixGmin2:ixGmax2,ndim),&
        ...
        dx2(ixGmin1:ixGmax1,ixGmin2:ixGmax2), dx3(ixGmin1:ixGmax1,&
       ixGmin2:ixGmax2)
    double precision :: exp_factor(ixGmin1:ixGmax1,ixGmin2:ixGmax2),&
       del_exp_factor(ixGmin1:ixGmax1,ixGmin2:ixGmax2),&
       exp_factor_primitive(ixGmin1:ixGmax1,ixGmin2:ixGmax2)
