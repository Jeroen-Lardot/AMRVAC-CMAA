...
contains
  ...
  subroutine mf_read_params(files)
    ...
    namelist /mf_list/ mf_nu, mf_decay_scale, mf_eta, mf_eta_hyper,&
        mf_glm_alpha, mf_particles,mf_4th_order, typedivbfix,&
        source_split_divb, divbdiff,typedivbdiff, type_ct, compactres,&
        divbwave, He_abundance, SI_unit, B0field,B0field_forcefree, Bdip,&
        Bquad, Boct, Busr, boundary_divbfix, boundary_divbfix_skip,&
        mf_divb_4thorder
...
111    close(unitpar)
  ...
  subroutine mf_get_cmax(w,x,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    call mf_get_csound(w,x,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
       ixOmax1,ixOmax2,idim,cmax)

    cmax(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=abs(w(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,mom(idim)))+cmax(ixOmin1:ixOmax1,ixOmin2:ixOmax2)
  ...
  subroutine mf_get_cbounds(wLC,wRC,wLp,wRp,x,ixImin1,ixImin2,ixImax1,ixImax2,&
    ...
    call mf_get_csound(wmean,x,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
       ixOmax1,ixOmax2,idim,csoundR)
  ...
  subroutine mf_get_csound(w,x,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
     ixOmax1,ixOmax2,idim,csound)
    use mod_global_parameters
  ...
  subroutine mf_velocity_update(qdt, qt, active)
    ...
    do iigrid=1,igridstail_active; igrid=igrids_active(iigrid);
      ...
      call frictional_velocity(ps(igrid)%w,ps(igrid)%x,ixGlo1,ixGlo2,ixGhi1,&
         ixGhi2,ixMlo1,ixMlo2,ixMhi1,ixMhi2,qdt)
    end do
    !$OMP END PARALLEL DO
  ...
  subroutine frictional_velocity(w,x,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
    ...
    double precision :: dxhms(ixOmin1:ixOmax1,ixOmin2:ixOmax2),&
       decay(ixOmin1:ixOmax1,ixOmin2:ixOmax2)
    ...
    if(slab) then
      if(slab_uniform) then
        ...
        decay(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=1.d0-exp(-x(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2,ndim)/mf_decay_scale)
        do idir=1,ndir
        ...
        dxhms(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=dble(ndim)/sum(1.d0/block%ds(&
      ...
      ! decay frictional velocity near solar surface
      decay(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=1.d0-exp(-x(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,1)/mf_decay_scale)
      do idir=1,ndir
        w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,mom(idir))=dxhms(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2)*w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           mom(idir))*tmp(ixOmin1:ixOmax1,&
  ...
  subroutine get_normalized_divb(w,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
    ...
    if(slab_uniform) then
      divb(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=0.5d0*abs(divb(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2))/sqrt(mf_mag_en_all(w,ixImin1,ixImin2,ixImax1,&
  ...
  subroutine get_current(w,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    if(present(fourthorder)) then
      call curlvector(bvec,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
         ixOmax1,ixOmax2,current,idirmin,idirmin0,ndir,fourthorder)
    else
      call curlvector(bvec,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
  ...
  subroutine record_force_free_metrics()
    ...
    call MPI_ALLREDUCE(sum_jbb_ipe,sum_jbb,1,MPI_DOUBLE_PRECISION,MPI_SUM,&
       icomm,ierrmpi)
    call MPI_ALLREDUCE(sum_j_ipe,sum_j,1,MPI_DOUBLE_PRECISION,MPI_SUM,icomm,&
       ierrmpi)
    call MPI_ALLREDUCE(f_i_ipe,f_i,1,MPI_DOUBLE_PRECISION,MPI_SUM,icomm,&
       ierrmpi)
    call MPI_ALLREDUCE(sum_l_ipe,sum_l,1,MPI_DOUBLE_PRECISION,MPI_SUM,icomm,&
       ierrmpi)
    call MPI_ALLREDUCE(volume_pe,volume,1,MPI_DOUBLE_PRECISION,MPI_SUM,icomm,&
       ierrmpi)
...
filehead="  it,  time,  <CW sin theta>,  <Current>,  <Lorenz force>,  <f_i>"
  ...
  function integral_grid_mf(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    double precision :: integral_grid_mf,tmp(ixImin1:ixImax1,ixImin2:ixImax2),&
       dsurface(ixOmin1:ixOmax1,ixOmin2:ixOmax2)
    integer :: ix1,ix2,idirmin,idir,jdir,kdir,idims,hxOmin1,hxOmin2,hxOmax1,&
       hxOmax2
    ...
    select case(iw)
     case(1)
      ...
      if(B0field) then
        bvec(ixImin1:ixImax1,ixImin2:ixImax2,:)=w(ixImin1:ixImax1,&
           ixImin2:ixImax2,mag(:))+block%b0(ixImin1:ixImax1,ixImin2:ixImax2,&
           mag(:),0)
      else
        bvec(ixImin1:ixImax1,ixImin2:ixImax2,:)=w(ixImin1:ixImax1,&
           ixImin2:ixImax2,mag(:))
