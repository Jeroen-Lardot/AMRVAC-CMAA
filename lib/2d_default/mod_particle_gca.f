...
contains
    ...
    do n = 1, num_particles
      ...
      if(ipe_particle == mype) then
        ...
        if (.not. associated(usr_update_payload)) then
          call gca_update_payload(igrid,ps(igrid)%w,pso(igrid)%w,ps(igrid)%x,&
             x(:,n),v(:,n)*lfac,q(n),m(n),payload,npayload,0.d0)
        else
  ...
  subroutine gca_fill_gridvars
    ...
    do iigrid=1,igridstail; igrid=igrids(iigrid);
       ...
       do idir=1,ndir
         vE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,idir) = vE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
            idir) / absB(ixGlo1:ixGhi1,ixGlo2:ixGhi2)**2
       end do
       ...
       if(time_advance) then
         ...
         absB(ixGlo1:ixGhi1,ixGlo2:ixGhi2) = &
            ...
            bp(:))**2,dim=ndim+1))
         vE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,1) = &
         ...
         vE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,2) = &
            gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
         ...
         vE(ixGlo1:ixGhi1,ixGlo2:ixGhi2,3) = &
            gridvars(igrid)%wold(ixGlo1:ixGhi1,ixGlo2:ixGhi2,&
    ...
    ! y(ndir+3) = particle(ipart)%self%u(3) ! Lorentz factor of particle
      ...
      if (.not. associated(usr_update_payload)) then
        call gca_update_payload(particle(ipart)%igrid,&
           ...
           particle(ipart)%self%u,q,m,payload,npayload,&
