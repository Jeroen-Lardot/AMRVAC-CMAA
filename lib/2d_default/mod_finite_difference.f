...
contains
  ...
  subroutine fd(method,qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
     ixOmax1,ixOmax2,idimsmin,idimsmax,qtC,sCT,qt,snew,fC,fE,dx1,dx2,x)
    use mod_physics
    ...
    do idims= idimsmin,idimsmax
       ...
       fC(ixCmin1:ixCmax1,ixCmin2:ixCmax2,1:nwflux,&
          idims) = fpL(ixCmin1:ixCmax1,ixCmin2:ixCmax2,&
          1:nwflux) + fmR(ixCmin1:ixCmax1,ixCmin2:ixCmax2,1:nwflux)
    ...
    case default 
       ...
       do iw=1,nwflux
          ...
          call dwlimiter2(dwC,ixImin1,ixImin2,ixImax1,ixImax2,ixCmin1,ixCmin2,&
             ixCmax1,ixCmax2,idims,typelimiter,ldw=ldw,a2max=a2max)
  ...
  subroutine reconstructR(ixImin1,ixImin2,ixImax1,ixImax2,iLmin1,iLmin2,iLmax1,&
    ...
    case default 
       ...
       do iw=1,nwflux
          ...
          call dwlimiter2(dwC,ixImin1,ixImin2,ixImax1,ixImax2,ixCmin1,ixCmin2,&
             ixCmax1,ixCmax2,idims,typelimiter,rdw=rdw,a2max=a2max)
  ...
  subroutine centdiff(method,qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
     ixOmin2,ixOmax1,ixOmax2,idimsmin,idimsmax,qtC,sCT,qt,s,fC,fE,dx1,dx2,x)
    ...
    do idims= idimsmin,idimsmax
       ...
       if(method=='cd') then
          fC(ixCmin1:ixCmax1,ixCmin2:ixCmax2,1:nwflux,&
             ...
             1:nwflux)+f(jxCmin1:jxCmax1,jxCmin2:jxCmax2,1:nwflux))
       else
          ! f_i+1/2= (-f_(i+2) +7 f_(i+1) + 7 f_i - f_(i-1))/12
          fC(ixCmin1:ixCmax1,ixCmin2:ixCmax2,1:nwflux,&
             idims)=(-f(kxCmin1:kxCmax1,kxCmin2:kxCmax2,&
             1:nwflux)+7.0d0*(f(jxCmin1:jxCmax1,jxCmin2:jxCmax2,&
             1:nwflux) + f(ixCmin1:ixCmax1,ixCmin2:ixCmax2,&
             1:nwflux))-f(hxCmin1:hxCmax1,hxCmin2:hxCmax2,1:nwflux))/12.0d0
    ...
    if(stagger_grid) call phys_update_faces(ixImin1,ixImin2,ixImax1,ixImax2,&
       ixOmin1,ixOmin2,ixOmax1,ixOmax2,qt,qdt,wprim,fC,fE,sCT,s)
