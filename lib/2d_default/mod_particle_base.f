...
contains
  ...
  subroutine particles_params_read(files)
    ...
    namelist /particles_list/ physics_type_particles,nparticleshi,&
        nparticles_per_cpu_hi, particles_eta, particles_etah, write_individual,&
        write_ensemble, write_snapshot, dtsave_particles,num_particles,&
       npayload,tmax_particles, dtheta,losses, const_dt_particles,&
