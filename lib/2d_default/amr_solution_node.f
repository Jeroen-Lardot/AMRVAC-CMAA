...
subroutine alloc_node(igrid)
  ...
  double precision :: delx(ixGlo1:ixGhi1,1),xc(ixGlo1:ixGhi1,1),&
     delxc(ixGlo1:ixGhi1,1)
  double precision :: exp_factor(ixGlo1:ixGhi1),del_exp_factor(ixGlo1:ixGhi1),&
     exp_factor_primitive(ixGlo1:ixGhi1)
