...
contains
  ...
  subroutine geteigenjump2_iso(wL,wR,wroe,x,ixmin1,ixmin2,ixmax1,ixmax2,il,&
    ...
    select case (typeaverage)
    case ('arithmetic')
       csound(ixmin1:ixmax1,ixmin2:ixmax2)=sqrt(rhd_adiab*rhd_gamma*wroe(&
          ixmin1:ixmax1,ixmin2:ixmax2,rho_)**(rhd_gamma-one))
    ...
    case ('roe','default')
       where(abs(wL(ixmin1:ixmax1,ixmin2:ixmax2,rho_)-wR(ixmin1:ixmax1,&
          ...
          csound(ixmin1:ixmax1,ixmin2:ixmax2)=sqrt(rhd_adiab*rhd_gamma*wroe(&
             ixmin1:ixmax1,ixmin2:ixmax2,rho_)**(rhd_gamma-one))
       elsewhere
          csound(ixmin1:ixmax1,ixmin2:ixmax2)=sqrt(rhd_adiab*(wR(ixmin1:ixmax1,&
             ixmin2:ixmax2,rho_)**rhd_gamma-wL(ixmin1:ixmax1,ixmin2:ixmax2,&
             rho_)**rhd_gamma)/(wR(ixmin1:ixmax1,ixmin2:ixmax2,&
    ...
    case('harten','powell')
       ...
       if (il == soundRW_) then
          tmp(ixmin1:ixmax1,ixmin2:ixmax2) =wL(ixmin1:ixmax1,ixmin2:ixmax2,&
             mom(idim))/wL(ixmin1:ixmax1,ixmin2:ixmax2,&
             rho_)+ sqrt(rhd_adiab*rhd_gamma*wL(ixmin1:ixmax1,ixmin2:ixmax2,&
             rho_)**(rhd_gamma-one))
          tmp2(ixmin1:ixmax1,ixmin2:ixmax2)=wR(ixmin1:ixmax1,ixmin2:ixmax2,&
             mom(idim))/wR(ixmin1:ixmax1,ixmin2:ixmax2,&
             rho_)+ sqrt(rhd_adiab*rhd_gamma*wR(ixmin1:ixmax1,ixmin2:ixmax2,&
             rho_)**(rhd_gamma-one))
       else if (il == soundLW_) then
          tmp(ixmin1:ixmax1,ixmin2:ixmax2) =wL(ixmin1:ixmax1,ixmin2:ixmax2,&
             mom(idim))/wL(ixmin1:ixmax1,ixmin2:ixmax2,&
